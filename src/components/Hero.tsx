        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-1">
              <motion.h1
                className="font-signature text-[7rem] sm:text-[9rem] lg:text-[18rem] text-white leading-none select-none"
                style={{
              ...
              <motion.p
                className="text-sky-300 text-lg lg:text-base font-semibold tracking-[0.28em] uppercase font-sans"
