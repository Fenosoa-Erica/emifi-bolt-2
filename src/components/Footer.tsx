...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-navy-900 border-t border-white/5 overflow-hidden" role="contentinfo">
      <div className="absolute inset-0 bg-gradient-to-b from-slate-900 to-navy-900 pointer-events-none" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-32 bg-sky-500/5 blur-3xl pointer-events-none" />
